...
Metadata will be organised using [Seedcase Sprout](https://sprout.seedcase-project.org), based on the data recorded in REDCap (for data registered there) and a data dictionary for Fitrockr.

This will result in metadata that is consistent, comprehensive, and aligned with [FAIR](https://en.wikipedia.org/wiki/FAIR_data) principles.
